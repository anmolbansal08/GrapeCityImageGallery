...
{
    class CircularButton : Button//Circular Button Class inherits 
        //from predefined Button Class
    {

        protected override void OnPaint(PaintEventArgs pevent)//overrides OnPaint Method of Button Class
