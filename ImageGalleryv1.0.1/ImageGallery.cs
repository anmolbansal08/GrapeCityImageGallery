...
{
    public partial class ImageGallery : Form//represents a window that makes up Application's Interface
    {
        ...
        //This counter will be used to show or hide the export button
        ...
        int searchlimit = 4;//we can set searchLimit on our own
            ...
            if ((Noofsearches < searchlimit))
            {
                ...
                try
                {
                    ...
                    if (!isbuttonclicked)// if button not click tells custom search On
                    {
                        ...
                        while (get.Equals(""))
                        {
                            string message = "Please enter something in the CustomInputBox";
                            
                            //String messageindifflanguage=function(message);
        ...
        private void finalsetup()
        {
            ...
            Noofsearches++;
            searchesleftlabel.Visible = true;
